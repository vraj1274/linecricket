...
import { ArrowLeft, Save, X, Loader2, CheckCircle, Edit3 } from 'lucide-react';
...
export function ComprehensiveProfileEdit({ profileType, profileId, initialData, onBack, onSave }: ComprehensiveProfileEditProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await profileUpdateService.updateProfile(profileType, profileId, formData);
